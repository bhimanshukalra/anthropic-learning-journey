> **Source / attribution:** [OlivierAlter/Claude-Certified-Architect-Foundations-Certification-Exam](https://github.com/OlivierAlter/Claude-Certified-Architect-Foundations-Certification-Exam/blob/main/Claude%20Certification%20Exam.md)
> — community-authored practice exam, © its author (repo has **no license**; kept here for
> personal study only, do not redistribute). Fetched 2026-07-09. Check the source for updates.
>
> ⚠️ **Answers are inline** after every question — do NOT read this file casually before a
> mock, or it stops being a clean readiness signal. Have the examiner (Claude) administer
> questions from it instead. Not official Anthropic material — verify surprising answers
> against `EXAM-PREP.md` / the official guide.
