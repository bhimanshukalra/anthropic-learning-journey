...
class CliChat(Chat):
    ...
    async def list_prompts(self) -> list[Prompt]:
        # This path supports slash-command autocomplete in the CLI.
        logger.debug("Listing CLI prompts")
        return await self.doc_client.list_prompts()

    async def list_docs_ids(self) -> list[str]:
        # This reads the document list resource used for @mention autocomplete.
        logger.debug("Listing document ids")
        return await self.doc_client.read_resource("docs://documents")

    async def get_doc_content(self, doc_id: str) -> str:
        # This reads the actual content after a user mentions a document.
        logger.debug("Fetching document content for '%s'", doc_id)
    ...
    async def _extract_resources(self, query: str) -> str:
        ...
        # Mention counts make it easy to tell whether context injection ran.
        logger.info("Extracting %d document mentions from query", len(mentions))
        ...
        for doc_id in doc_ids:
            if doc_id in mentions:
                ...
                # Log only the document id, not full document contents.
                logger.info("Added mentioned document '%s' to query context", doc_id)
    ...
    async def _process_command(self, query: str) -> bool:
        ...
        # Slash commands become MCP prompt requests.
